...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.pembimbing.driver' => 'string',
            'auth.guards.pembimbing.provider' => 'string',
            ...
            'auth.providers.pembimbings.driver' => 'string',
            'auth.providers.pembimbings.model' => 'string',
            ...
            'filesystems.links.C:\xampp\htdocs\Project\LaporanPkl\public\storage' => 'string',
...
'auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.pembimbing.driver','auth.guards.pembimbing.provider','auth.providers.users.driver',
'auth.providers.users.model','auth.providers.admins.driver','auth.providers.admins.model','auth.providers.pembimbings.driver','auth.providers.pembimbings.model',
...
'filesystems.links.C:\\xampp\\htdocs\\Project\\LaporanPkl\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'session.same_site','session.partitioned','sweetalert.theme','sweetalert.cdn','sweetalert.alwaysLoadJS',
'sweetalert.neverLoadJS','sweetalert.timer','sweetalert.width','sweetalert.height_auto','sweetalert.padding',
'sweetalert.background','sweetalert.animation.enable','sweetalert.animatecss','sweetalert.show_confirm_button','sweetalert.show_close_button',
'sweetalert.button_text.confirm','sweetalert.button_text.cancel','sweetalert.toast_position','sweetalert.timer_progress_bar','sweetalert.middleware.autoClose',
'sweetalert.middleware.toast_position','sweetalert.middleware.toast_close_button','sweetalert.middleware.timer','sweetalert.middleware.auto_display_error_messages','sweetalert.customClass.container',
'sweetalert.customClass.popup','sweetalert.customClass.header','sweetalert.customClass.title','sweetalert.customClass.closeButton','sweetalert.customClass.icon',
'sweetalert.customClass.image','sweetalert.customClass.content','sweetalert.customClass.input','sweetalert.customClass.actions','sweetalert.customClass.confirmButton',
'sweetalert.customClass.cancelButton','sweetalert.customClass.footer','sweetalert.confirm_delete_confirm_button_text','sweetalert.confirm_delete_confirm_button_color','sweetalert.confirm_delete_cancel_button_color',
'sweetalert.confirm_delete_cancel_button_text','sweetalert.confirm_delete_show_cancel_button','sweetalert.confirm_delete_show_close_button','sweetalert.confirm_delete_icon','sweetalert.confirm_delete_show_loader_on_confirm',
...
'login','login.proses','admin.dashboard','admin.siswa.index','admin.siswa.create',
'admin.siswa.store','admin.siswa.edit','admin.siswa.update','admin.siswa.destroy','admin.pembimbing.index',
'admin.pembimbing.create','admin.pembimbing.store','admin.pembimbing.edit','admin.pembimbing.update','admin.pembimbing.destroy',
'admin.pkl.index','admin.pkl.create','admin.pkl.store','admin.pkl.edit','admin.pkl.update',
'admin.pkl.destroy','admin.laporan.index','admin.laporan.create','admin.laporan.store','admin.laporan.edit',
'admin.laporan.update','admin.laporan.destroy','admin.penilaian.index','admin.penilaian.create','admin.penilaian.store',
'admin.penilaian.edit','admin.penilaian.update','admin.penilaian.destroy','admin.absensi.index','admin.absensi.create',
...
'components.modals.penilaian-modal','components.modals.siswa-modal','components.modals.tempatPkl-modal','components.table.data-table','components.table.table',
'js.modal-handler','js.select-handler','layouts.app','partials.absensi.data-table-vars','partials.absensi.nama',
'partials.absensi.nama-mobile','partials.absensi.status','partials.laporan.data-table-vars','partials.laporan.jenis-laporan','partials.laporan.judul-laporan',
'partials.laporan.judul-laporan-mobile','partials.pembimbing.data-table-vars','partials.pembimbing.jumlah-siswa','partials.pembimbing.nama','partials.pembimbing.nama-mobile',
'partials.penilaian.data-table-vars','partials.penilaian.nama','partials.penilaian.nama-mobile','partials.penilaian.nilai-akhir','partials.siswa.data-table-vars',
'partials.siswa.nama','partials.siswa.nama-mobile','partials.tempat-pkl.data-table-vars','partials.tempat-pkl.jumlah-siswa','partials.tempat-pkl.nama',
'partials.tempat-pkl.nama-mobile','pembimbing.dashboard.index','sweetalert::alert','vendor.sweetalert.alert','welcome',
